...
class PrivateRecipeAPITests(TestCase):
	...
	def test_full_update_recipe(self):
		"""Test full updating recipe with PUT"""
		recipe = sample_recipe(user=self.user)
		recipe.tags.add(sample_tag(user=self.user))
		payload = {
			'title': 'Spaghetti',
...
class RecipeImageUploadTests(TestCase):
	...
	def setUp(self):
		self.client = APIClient()
		self.user = get_user_model().objects.create_user('sampleuser@ntg.ai', 'testpass')
		self.client.force_authenticate(self.user)
	...
	def test_upload_recipe_image(self):
		"""Test that uploading image upload to recipe"""
	...
	def test_filter_recipes_by_tags(self):
		"""Test for returning recipes with specific tag"""
